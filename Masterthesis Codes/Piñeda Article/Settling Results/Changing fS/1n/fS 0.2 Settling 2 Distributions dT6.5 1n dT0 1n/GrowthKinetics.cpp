...
#ifndef GrowthKinetics
#define GrowthKinetics
...
#include "InterpolationFunctions.cpp"
...
void CAGrowth(){
        ...
        if( CA[ii*mx + ji].state >= 2 && fabs(CA[ii*mx + ji].theta) <= M_PI/4.0 + dtheta ){
